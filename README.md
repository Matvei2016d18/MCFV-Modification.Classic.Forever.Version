# MCFV-Modification.Classic.Forever.Version
# How to use it?

To create a modified version of **classic 0.30**, you need the following: *JDK* 8 or another version of *JDK*, Windows Command Port, and any archiver that can unzip zip files.
...
Source code of the **classic 0.30** version: https://github.com/ManiaDevelopment/Minecraft-Classic-Forever?ysclid=mpqnvilm1d61647455
